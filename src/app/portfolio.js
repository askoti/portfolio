        ...
        <div className='flex flex-row flex-wrap'>
            <div className='lg:w-1/2 md:w-1/2 sm:w-1/2'>
                <div className='flex flex-column flex-wrap'>
                    <div className='mb-10'>
                        <Image src='/../public/landing-page.png' width={700} height={500} className='p-4'/>
                    ...
                    <div>
                    <Image src='/../public/ecommerce.png' width={700} height={500} className='p-4'/>
                    <div className="flex flex-row justify-around">
            ...
            <div className='flex flex-column flex-wrap'>
                    <div className='mb-10'>
                        <Image src='/../public/crypto.png' width={700} height={500} className='p-4'/>
                        <div className="flex flex-row justify-around">
                    ...
                    <div>
                    <Image src='/../public/rickandmorty.png' width={700} height={500} className='p-4'/>
                    <div className="flex flex-row justify-around">
